...
//                if(loggedUser != null)
//                {
//                    System.out.println("there is a logged user");
//                    try(ObjectInputStream fromServer = new ObjectInputStream(serverSocket.getInputStream()))
//                    {
//                        Object objFromServer = fromServer.readObject();
...
//                        {
//                            System.out.println("object that was received is a notification");
//                            System.out.println(objFromServer.toString());
//
//                            loggedUser.addNotification((Notification)objFromServer);
//
//                            System.out.println("the logged user notifications:");
//
//                            for(Map.Entry<Notification, Boolean> entry : loggedUser.getNotifications().entrySet())
//                            {
//                                System.out.println(entry.getKey().getMsg());
//                            }
//
//
//                        }
