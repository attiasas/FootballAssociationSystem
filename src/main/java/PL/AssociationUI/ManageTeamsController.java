...
public class ManageTeamsController extends AInitComboBoxObjects {
        ...
        private CommunicationAssociationManagementStub clientServerCommunication = new CommunicationAssociationManagementStub(new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        ...
        public void addTeam(ActionEvent actionEvent)
        {
            ...
            if (associationManagementUnit.addTeam(teamName.getText(), fan))
            {
                //showMessage(true);
